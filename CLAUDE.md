...
This is a personal dotfiles repository containing Emacs and zsh shell configurations for macOS. The files in this repository are designed to be symlinked from the home directory:
- `.emacs` → `~/.emacs`
- `.zshrc` → `~/.zshrc`
