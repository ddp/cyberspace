...
1. [Newton Programmer's Guide](https://www.newtonresearch.org/) - Soup and cursor APIs
2. [SQLite Query Planner](https://sqlite.org/queryplanner.html) - Query optimization
