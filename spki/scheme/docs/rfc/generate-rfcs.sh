...
<head>
  ...
  <style>
    ...
    h1 { border-bottom: 1px solid #0f0; padding-bottom: 0.3rem; font-size: 14pt; margin: 0 0 0.5rem 0; }
    h2 { font-size: 11pt; margin: 1rem 0 0.3rem 0; border-bottom: 1px solid #040; }
    p { margin: 0.3rem 0; font-size: 9pt; color: #080; }
    table { width: 100%; border-collapse: collapse; margin: 0.5rem 0; }
    th, td { padding: 0.2rem 0.4rem; text-align: left; border-bottom: 1px solid #040; font-size: 9pt; }
    th { background: #010; color: #0f0; }
    a { color: #0f0; text-decoration: none; }
    a:hover { color: #fff; text-decoration: underline; }
    a:visited { color: #0c0; }
    .formats a { margin-right: 0.4rem; font-size: 8pt; }
    footer { margin-top: 1rem; padding-top: 0.5rem; border-top: 1px solid #040; font-size: 8pt; color: #080; }
    .kwic { font-size: 8pt; }
    .kwic td { padding: 0.1rem 0.3rem; white-space: nowrap; }
    .kwic .left { text-align: right; color: #080; }
    .kwic .keyword { font-weight: bold; color: #0f0; }
    .kwic .right { text-align: left; color: #080; }
