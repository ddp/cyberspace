...
```
     ┌─────────┐
     │  Alice  │         Little fluffy clouds
     │ (lazy)  │         drifting in ambient space.
     └────┬────┘
          │
...
**Sync Model:** Manual/periodic, offline-first
**Trust Model:** Friends (non-adversarial)
