...
1. [Zstandard](https://github.com/facebook/zstd) - Facebook's compression algorithm
2. [Content-Defined Chunking](https://restic.net/blog/2015-09-12/restic-foundation1-cdc/) - Restic blog
3. [RFC-018: Sealed Archive Format](rfc-018-sealed-archive.md)
4. [RFC-020: Content-Addressed Storage](rfc-020-content-addressed-storage.md)
...
**Dependencies:** cas, zstd, soup
**Integration:** Storage layer, archive creation, replication
