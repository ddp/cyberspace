...
1. [Protocol Buffers - Updating A Message Type](https://developers.google.com/protocol-buffers/docs/proto#updating)
2. [Avro Schema Evolution](https://avro.apache.org/docs/current/spec.html#Schema+Resolution)
3. [RFC-020: Content-Addressed Storage](rfc-020-content-addressed-storage.md)
4. [RFC-025: Query Language](rfc-025-query-language.md)
...
**Dependencies:** soup, cas
**Integration:** Soup queries, federation, long-term preservation
