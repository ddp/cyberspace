...
Query planning uses Selinger-style cost estimation to select optimal execution plans. The optimizer considers:
...
The soup is archival - objects rarely change, making aggressive caching safe.
...
3. Selinger et al., "Access Path Selection in a Relational Database Management System" (1979) - Cost-based optimization
4. RFC-020: Content-Addressed Storage
5. RFC-021: Capability Delegation
6. RFC-026: Garbage Collection (generation-aware caching)

---

## Changelog

- **2026-01-09** - Cost-based query optimization: Selinger algorithm, cardinality estimation, histograms, multi-tier caching with generation-aware TTL
