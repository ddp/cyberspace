...
1. [Live Migration of Virtual Machines](https://dl.acm.org/doi/10.1145/1095810.1095816) - Clark et al.
2. [RFC-018: Sealed Archive Format](rfc-018-sealed-archive.md)
3. [RFC-022: Key Ceremony Protocol](rfc-022-key-ceremony.md)
4. [RFC-024: Network Protocol](rfc-024-network-protocol.md)
...
**Dependencies:** vault, cas, soup, federation
