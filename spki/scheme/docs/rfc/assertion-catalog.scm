...
(define *assertion-catalog*
  '(
    ...
    (instrumentation commits "./cyberspace-repl.scm" 4934)
    (instrumentation federation-changes "./cyberspace-repl.scm" 4965)
    (instrumentation gossip-exchanges "./cyberspace-repl.scm" 5216)
    ...
    (instrumentation peers-discovered "./cyberspace-repl.scm" 5208)
    (instrumentation queries "./cyberspace-repl.scm" 1250)
    (instrumentation reads "./vault.scm" 1196)
    (instrumentation seals "./cyberspace-repl.scm" 4935)
    (instrumentation signs "./cyberspace-repl.scm" 4945)
    (instrumentation syncs "./cyberspace-repl.scm" 1125)
    (instrumentation unlocks "./vault.scm" 310)
    (instrumentation verifies "./cyberspace-repl.scm" 4950)
