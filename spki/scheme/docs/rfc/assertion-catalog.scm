...
(define *assertion-catalog*
  '(
    ...
    (instrumentation commits "./cyberspace-repl.scm" 4960)
    (instrumentation decrypts "./vault.scm" 308)
    (instrumentation encrypts "./vault.scm" 252)
    (instrumentation federation-changes "./cyberspace-repl.scm" 4991)
    (instrumentation gossip-exchanges "./cyberspace-repl.scm" 5242)
    ...
    (instrumentation peers-discovered "./cyberspace-repl.scm" 5234)
    (instrumentation queries "./cyberspace-repl.scm" 1271)
    (instrumentation reads "./vault.scm" 1274)
    (instrumentation seals "./cyberspace-repl.scm" 4961)
    (instrumentation signs "./cyberspace-repl.scm" 4971)
    (instrumentation syncs "./cyberspace-repl.scm" 1146)
    (instrumentation unlocks "./vault.scm" 321)
    (instrumentation verifies "./cyberspace-repl.scm" 4976)
    (instrumentation votes "./cyberspace-repl.scm" 1352)
    (instrumentation wormholes "./cyberspace-repl.scm" 1838)
    (instrumentation writes "./vault.scm" 579)

    ;; === Security Errors ===
    (security-error capability-amplification "./cyberspace-repl.scm" 1880)
    (security-error confidentiality-violation "./cyberspace-repl.scm" 2095)
    (security-error delegate-denied "./cyberspace-repl.scm" 2130)
    (security-error delete-denied "./cyberspace-repl.scm" 2127)
    (security-error integrity-violation "./cyberspace-repl.scm" 2099)
    (security-error no-ambient-authority "./cyberspace-repl.scm" 2116)
    (security-error read-denied "./cyberspace-repl.scm" 2121)
    (security-error secure-clear "./cyberspace-repl.scm" 2289)
    (security-error secure-clear-failed "./cyberspace-repl.scm" 2277)
    (security-error write-denied "./cyberspace-repl.scm" 2124)
    ...
    (precondition attested? "./cyberspace-repl.scm" 1537)
    (precondition attested? "./cyberspace-repl.scm" 1565)
    (precondition directory-exists? ".vault/keys" "./cyberspace-repl.scm" 3749)
