...
(memo
  (number 4)
  (title "SPKI Authorization Integration")
  (section
    "Abstract"
  ...
  (section
    ...
    (subsection
      ...
      (list
        ...
        (item "Backup: Shamir secret sharing (see Memo-001)")
