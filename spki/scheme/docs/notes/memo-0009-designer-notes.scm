...
(soup-stat 'alice)  ; inspect object"))
  ...
  (section
    ...
    (subsection
      ...
      (table compact
        (row "04-06" "violet"   "brahma muhūrta" "ब्रह्म मुहूर्त" "pre-dawn meditation")
        (row "06-08" "gold"     "prātaḥkāla"     "प्रातःकाल"     "dawn")
        (row "08-11" "teal"     "saṅgava"        "सङ्गव"        "morning")
        (row "11-14" "phosphor" "madhyāhna"      "मध्याह्न"      "midday")
        (row "14-17" "neon"     "aparāhṇa"       "अपराह्ण"       "afternoon")
        (row "17-19" "orange"   "sāyāhna"        "सायाह्न"       "evening")
        (row "19-22" "coral"    "pradoṣa"        "प्रदोष"        "dusk")
        (row "22-04" "cyan"     "niśītha"        "निशीथ"        "night"))
