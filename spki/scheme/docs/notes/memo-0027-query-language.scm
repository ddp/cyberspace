...
(memo
  ...
  (section
    ...
    (p "A query language that sacrifices any of these properties creates either unusable archives or insecure ones.")
  ...
  (section
    ...
    (subsection
      ...
      (p "These factors can cause query performance to vary by orders of magnitude; the optimizer must consider all of them.")
